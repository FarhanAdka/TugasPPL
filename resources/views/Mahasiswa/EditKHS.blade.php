            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                  ...
                  <li><a class="dropdown-item" href="/user/mahasiswa/profile"><i class="icon-mid bi bi-person me-2"></i> MyProfile</a></li>
              ...
              <div class="card">
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form class="form" action="{{route('KHS.update', $khs->id)}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                      <div class="form-body">
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <select id="semester_aktif" class="form-control" name="semester_aktif">
                                <option value="{{$khs->semester_aktif}}" selected>{{$khs->semester_aktif}}</option>
                                <?php
                                for ($i = 1; $i <= 14; $i++) {
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text" id="jumlah_sks" class="form-control" name="jumlah_sks" placeholder="Jumlah SKS" value="{{$khs->jumlah_sks}}">
                            </div>
                          </div>
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text" id="ip" class="form-control" name="ip" value="{{ $khs->ip }}">
                            </div>
                          </div>
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text" id="ipk" class="form-control" name="ipk" value="{{ $khs->ipk }}">
                            </div>
                          </div>
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="file" id="scan_khs" class="form-control" name="scan_khs" value="{{ $khs->scan_khs }}> 
                            </div>
                          </div>
