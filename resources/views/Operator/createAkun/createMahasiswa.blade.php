...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item @if(isset($active_home)) {{ $active_home }} @endif has-sub">
                ...
                <ul class="submenu @if(isset($active_sub)) {{ $active_sub }} @endif">
                    ...
                    <li class="submenu-item @if(isset($active_user)) {{ $active_user }} @endif ">
                        <a href="/user/operator/tambahMahasiswa" class="submenu-link">Mahasiswa</a>
                        
                    </li>
                    
                    <li class="submenu-item  @if(isset($active_user)) {{ $active_user }} @endif ">
                        <a href="/user/operator/tambahdosenWali" class="submenu-link">Dosen Wali</a>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="extra-component-avatar.html" class="submenu-link">Mahasiswa</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="extra-component-divider.html" class="submenu-link">Dosen Wali</a>
              ...
              <div class="card">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('nim')}}" name="nim" class="form-control">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{old('angkatan')}}" name="angkatan" class="form-control">
                    </div>
