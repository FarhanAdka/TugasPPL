            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    ...
                    <div class="sidebar-toggler  x">
                        <a href="pp" class="sidebar-hide d-xl-none d-block"><i class="bi bi-x bi-middle"></i></a>
                    </div>
                </div>
            </div>
...
<form action="" method="POST">
    <input type="hidden" name="_token" value="ygkOb6AXuv7r54MhfHkUKnhVyDA72E0beyok2ysE" autocomplete="off">                    <div class="mb-3">
        <label for="username" class="form-label">Username</label>
        <input type="text" value="" name="username" class="form-control">
    </div>
    <div class="mb-3">
        <label for="nim" class="form-label">NIM</label>
        <input type="text" value="" name="nim" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" value="" name="angkatan" class="form-control">
    </div>
    <div class="mb-3 d-grid">
        <button name="submit" type="submit" class="btn btn-primary">Buat Akun</button>
    </div>
</form>
