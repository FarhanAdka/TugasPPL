                                                    ...
                                                    <div class="card-body px-4 py-4-5">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <!-- Modal -->
                                                                <div class="modal fade" id="belumPKL{{$tahun}}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Daftar Mahasiswa yang Belum Lulus PKL Angkatan
                                                                                    {{ $tahun }}
                                                                                </h5>
                                                                                <button type="button"
                                                                                    class="btn-close"
                                                            ...
                                                            <div>
                                                                ...
                                                                <!-- Modal -->
                                                                <div class="modal fade" id="sudahPKL{{$tahun}}"
                                                                    tabindex="-1" aria-labelledby="exampleModalLabel"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Daftar Mahasiswa yang Sudah Lulus PKL Angkatan
                                                                                    {{ $tahun }}
                                                                                </h5>
                                                                                <button type="button"
                                                                                    class="btn-close"
                                                    ...
                                                    <div class="card-body px-4 py-4-5">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div>
                                                                ...
                                                                <!-- Modal -->
                                                                <div class="modal fade" id="belumSkripsi{{$tahun}}"
                                                                    tabindex="-1" aria-labelledby="exampleModalLabel"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Daftar Mahasiswa yang Belum Lulus Skripsi Angkatan
                                                                                    {{ $tahun }}
                                                                                </h5>
                                                                                <button type="button"
                                                                                    class="btn-close"
                                                            ...
                                                            <div>
                                                                ...
                                                                <!-- Modal -->
                                                                <div class="modal fade" id="sudahSkripsi{{$tahun}}"
                                                                    tabindex="-1" aria-labelledby="exampleModalLabel"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Daftar Mahasiswa yang Sudah Lulus Skripsi Angkatan
                                                                                    {{ $tahun }}
                                                                                </h5>
                                                                                <button type="button"
                                                                                    class="btn-close"
