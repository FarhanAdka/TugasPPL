            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item has-sub {{ $title === 'Tambah Akun Mahasiswa' ||
                            ...
                            <ul class="submenu">
                                <li class="submenu-item {{ $title === 'Tambah Akun Mahasiswa' ? 'active' : '' }} ">
                                    <a href="/user/operator/tambahMahasiswa" class="submenu-link">
                                        <span>Mahasiswa</span>
                                    </a>
                                </li>

                                <li class="submenu-item   {{ $title === 'Tambah Akun Dosen Wali' ? 'active' : '' }} ">
                                    <a href="/user/operator/tambahdosenWali" class="submenu-link">
                                        <span>Dosen Wali</span>
                                    </a>

                                </li>

                                <li class="submenu-item   {{ $title === 'Tambah Akun Operator' ? 'active' : '' }} ">
                                    <a href="/user/operator/tambahOperator" class="submenu-link">Operator</a>

                                </li>

                                <li class="submenu-item   {{ $title === 'Tambah Data Mahasiswa' ? 'active' : '' }} ">
                        ...
                        <li
                            class="sidebar-item has-sub {{ $title === 'Kelola Akun Mahasiswa' || $title === 'Kelola Akun Dosen Wali' || $title === 'Edit Akun Mahasiswa' || $title === 'Edit Akun Dosen Wali' ? 'active' : '' }} ">
                            <a href="#" class='sidebar-link'>
                            ...
                            <ul class="submenu ">
                                ...
                                <li
                                    class="submenu-item  {{ $title === 'Kelola Akun Mahasiswa' || $title === 'Edit Akun Mahasiswa' ? 'active' : '' }} ">
                                    <a href="/user/operator/kelolaMahasiswa" class="submenu-link">Mahasiswa</a>

                                </li>

                                <li
                                    class="submenu-item {{ $title === 'Kelola Akun Dosen Wali' || $title === 'Edit Akun Dosen Wali' ? 'active' : '' }} ">
                                    <a href="/user/operator/keloladosenWali" class="submenu-link">Dosen Wali</a>
