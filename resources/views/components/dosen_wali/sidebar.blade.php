            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ $title === 'Dosen Wali' ? 'active' : '' }}">
                            <a href="/user/dosenWali/" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item has-sub {{ $title === 'Verifikasi IRS' || $title === 'List IRS' ? 'active' : '' }}">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-file-earmark-text-fill"></i>
                                <span>Data IRS</span>
                            </a>
                            <ul class="submenu">
                                <li class="submenu-item {{ $title === 'Verifikasi IRS' ? 'active' : '' }}">
                                    <a href="/user/dosenWali/verifikasiIRS" class="submenu-link">
                                        <span>Verifikasi IRS</span>
                                    </a>
                                </li>
                                <li class="submenu-item {{ $title === 'List IRS' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item  has-sub {{ $title === 'Verifikasi KHS' || $title === 'List KHS' ? 'active' : '' }}">
                            <a href="#" class='sidebar-link'>
                                <i class="bi bi-file-post-fill"></i>
                                <span>Data KHS</span>
                            </a>
                            <ul class="submenu">
                                <li class="submenu-item {{ $title === 'Verifikasi KHS' ? 'active' : '' }}">
                                    <a href="/user/dosenWali/verifikasiKHS" class="submenu-link">
                                        <span>Verifikasi KHS</span>
                                    </a>
                                </li>
                                <li class="submenu-item {{ $title === 'List KHS' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item has-sub {{ $title === 'Verifikasi PKL' || $title === 'List PKL' ? 'active' : '' }}">
                            <a href="#" class='sidebar-link'>
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item {{ $title === 'List PKL' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item has-sub {{ $title === 'Verifikasi Skripsi' || $title === 'List Skripsi' ? 'active' : '' }}">
                            <a href="#" class='sidebar-link'>
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item {{ $title === 'List Skripsi' ? 'active' : '' }}">
                                    ...
                                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="user-menu d-flex">
                                            <div class="user-name text-end me-3">
                                                ...
                                                <p class="mb-0 text-sm text-gray-600">Dosen Wali</p>
                                            </div>
